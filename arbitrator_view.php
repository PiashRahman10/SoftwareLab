...
<meta charset="utf-8">
    ...
    <style>
        ...
        .arbitrator-info strong {
            color: #555;
        }

        .arbitrator-info .divider {
            width: 100%;
            height: 1px;
...
<body>
    ...
    <!-- Arbitrator Profile Section -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <!-- Arbitrator profile card -->
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="arbitrator-profile-card">
                        <!-- Left side: Image -->
                        <div class="arbitrator-image">
                            <?php
                            if (!empty($datax['pic'])) {
                                echo "<img src='arbpic/" . $datax['pic'] . "' alt='Arbitrator Image'>";
                            } else {
