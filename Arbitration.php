...
<?php
   $host = 'localhost';
    ...
    if(isset($_POST['submit2'])){
        ...
        /**
         * check corner case like : arbitration proposal er case no check kora
         * solution : arbitration proposal theke case no niye ekta variable e rakhbo then sql e where e check korbo
         * 
         */


        $sql = "INSERT INTO arbitration_case (file,fullname,fathername,mothername,nid,phone,email,dob,occupation,address,complaint,demand,casenumber)
        VALUES('$file','$fullname','$fathername','$mothername','$nid','$phone','$email','$dob','$occupation','$address','$complaint','$demand','$case')";
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="file">Impotrant File</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
