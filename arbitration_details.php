...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
 ...
 <!-- Navbar End -->
    ...
    <div class="container light-style flex-grow-1 container-p-y">
        <h4 class=""></h4>
        <div class="row">
            <div class="col-lg-4 " style=" background: skyblue">
                <h2 style="text-align:center; background: skyblue">Your part</h2>
                <h5>Case file: </h5>
            </div>

            <div class="col-lg-4 " style=" background: lightblue">
               <h2 style="text-align:center; background: lightblue"> Arbitrator</h2>
               <div>
                    <h4>First meeting: <br></h4>
                    <h6>
                    time: <br>
                    date: <br>
                    duration: <br>
            ...
            <div class="col-lg-4 " style=" background: skyblue">
               <h2 style="text-align:center; background: skyblue">Oponent part</h2>
               <h5>Case file: </h5>
            </div>
