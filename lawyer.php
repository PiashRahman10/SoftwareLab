        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Lawyer Information</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp lawyer-card" data-wow-delay="0.2s">
                            <div class="card border-0 shadow-sm h-100 text-center p-4">
                                <div class="card-body">
                                    ...
                                    <?php echo "<a href='appointment.php?lawyer_id=" . $lawyer['lawyer_id'] . "' class='btn btn-primary rounded-pill'>Book Appointment</a>"; ?>
